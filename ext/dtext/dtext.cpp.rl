...
inline := |*
  ...
  'issue #'i id            => { append_id_link(sm, "issue", "github", "https://github.com/lunaisnotaboy/ori/issues/", { sm->a1, sm->a2 }); };
  'pull #'i id             => { append_id_link(sm, "pull", "github-pull", "https://github.com/lunaisnotaboy/ori/pull/", { sm->a1, sm->a2 }); };
  'commit #'i id           => { append_id_link(sm, "commit", "github-commit", "https://github.com/lunaisnotaboy/ori/commit/", { sm->a1, sm->a2 }); };
