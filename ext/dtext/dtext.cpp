...
#line 311 "ext/dtext/dtext.cpp.rl"
	{( sm->te) = ( sm->p);( sm->p)--;{ append_id_link(sm, "commit", "github-commit", "https://github.com/lunaisnotaboy/ori/commit/", { sm->a1, sm->a2 }); }}
	goto st1127;
tr1609:
#line 72 "ext/dtext/dtext.cpp.rl"
	{ sm->a2 = sm->p; }
...
#line 309 "ext/dtext/dtext.cpp.rl"
	{( sm->te) = ( sm->p);( sm->p)--;{ append_id_link(sm, "issue", "github", "https://github.com/lunaisnotaboy/ori/issues/", { sm->a1, sm->a2 }); }}
	goto st1127;
tr1693:
#line 72 "ext/dtext/dtext.cpp.rl"
	{ sm->a2 = sm->p; }
...
#line 310 "ext/dtext/dtext.cpp.rl"
	{( sm->te) = ( sm->p);( sm->p)--;{ append_id_link(sm, "pull", "github-pull", "https://github.com/lunaisnotaboy/ori/pull/", { sm->a1, sm->a2 }); }}
	goto st1127;
tr1758:
#line 72 "ext/dtext/dtext.cpp.rl"
	{ sm->a2 = sm->p; }
