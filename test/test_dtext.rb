...
class DTextTest < Minitest::Test
  ...
  def test_id_links
    ...
    assert_parse_id_link("dtext-github-id-link", "https://github.com/lunaisnotaboy/ori/issues/1234", "issue #1234")
    assert_parse_id_link("dtext-github-pull-id-link", "https://github.com/lunaisnotaboy/ori/pull/1234", "pull #1234")
    assert_parse_id_link("dtext-github-commit-id-link", "https://github.com/lunaisnotaboy/ori/commit/1234", "commit #1234")
